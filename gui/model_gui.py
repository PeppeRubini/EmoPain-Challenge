...
class svr_gui(lstm_gui):
    ...
    def predict(self):
        ...
        pain = model_svr.predict(self.df_au.tail(1))
        self.n_prediction += 1
        print(pain[0])
    ...
    def change_to_lstm(self):
        self.root.withdraw()
        lstm_gui(tk.Toplevel(self.root))


model_svr = load('../pain_model/svr.pkl')
model_lstm = keras.models.load_model('../pain_model/modello90-05_1.h5')
